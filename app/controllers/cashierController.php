<?php
	...
	class cashierController extends mainModel{
		...
		public function registrarCajaControlador(){
		    ...
		    $sql = $this->conectar()->prepare("SELECT caja_numero FROM caja WHERE caja_numero = :numero");
		    ...
		    $sql = $this->conectar()->prepare("SELECT caja_nombre FROM caja WHERE caja_nombre = :nombre");
		...
		public function eliminarCajaControlador(){
			...
			# Verificando caja #
		    $sql = $this->conectar()->prepare("SELECT * FROM caja WHERE caja_id = :id");
		    $sql->bindValue(':id', $id);
		    $sql->execute();
		    $datos = $sql;
		    if($datos->rowCount()<=0){
		    ...
		    # Verificando ventas #
		    $sql = $this->conectar()->prepare("SELECT caja_id FROM venta WHERE caja_id = :id LIMIT 1");
		    $sql->bindValue(':id', $id);
		    $sql->execute();
		    $check_ventas = $sql;
		    ...
		    $sql = $this->conectar()->prepare("SELECT caja_id FROM usuario WHERE caja_id = :id LIMIT 1");
		    $sql->bindValue(':id', $id);
		    $sql->execute();
		    $check_usuarios = $sql;
