<?php
	...
	class categoryController extends mainModel{
		...
		public function registrarCategoriaControlador(){
		    ...
		    # Verificando nombre #
		    $sql = $this->conectar()->prepare("SELECT nombre FROM categoria WHERE nombre = :nombre");
		...
		public function eliminarCategoriaControlador(){
		    ...
		    $sql = $this->conectar()->prepare("SELECT * FROM categoria WHERE categoria_id = :id");
		    $sql->bindValue(':id', $id);
		    $sql->execute();
		    $datos = $sql;
		    if($datos->rowCount()<=0){
		    ...
		    $sql = $this->conectar()->prepare("SELECT categoria_id FROM producto WHERE categoria_id = :id LIMIT 1");
		    $sql->bindValue(':id', $id);
		    $sql->execute();
		    $check_productos = $sql;
