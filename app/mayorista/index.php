...
// Solo mayoristas pueden acceder
...
<div class="container">
  ...
  <div class="hero">
    <div class="hero-left">
      <div class="hero-eyebrow">Programa Mayorista</div>
      <h1 class="hero-title">Precios <em>exclusivos</em></h1>
      <p class="hero-desc">Acceso a catálogo mayorista con descuentos por volumen. Precios especiales según cantidad de compra.</p>
  ...
  <div class="notice notice-gold">
    ★ Bienvenido mayorista. Estás viendo precios mayoristas con descuentos por volumen automáticos.
  </div>
  ...
  <section id="catalogo">
    <div class="section-head">
      ...
      <span style="font-family:var(--font-mono);font-size:.72rem;color:var(--white3)"><?= count($productosFull) ?> productos</span>
    </div>
    ...
    <div class="product-grid">
      <?php if (empty($productosFull)): ?>
        <div class="no-results">
          ...
          <p>Probá otros filtros o <a href="<?php echo APP_URL . 'app/mayorista/index.php'; ?>" style="color:var(--white2)">ver todos</a></p>
        </div>
      <?php else: ?>
          ...
          <div class="product-card fade-in" data-search="<?= htmlspecialchars($searchData) ?>"
            ...
            <div class="product-card-img">
              ...
              <div class="card-badges">
                ...
                <?php endif; ?>
                <span class="badge badge-gold" style="font-size:.55rem">★ MAYORISTA</span>
              </div>
            </div>
            <div class="product-card-body">
              ...
              <div class="product-card-foot">
                <div class="product-price">
                  <?php if ($pMinorista && $pMinorista > $precio): ?>
