...
<head>
  ...
  <title><?= $pageTitle ?? 'BRITECH — Mayoristas' ?></title>
  <link rel="stylesheet" href="<?php echo APP_URL . 'app/mayorista/assets/css/style-light.css'; ?>">
</head>
<body>

<header class="site-header">
  <div class="header-inner">
    <a href="<?php echo APP_URL . 'app/mayorista/index.php'; ?>" class="logo">
      BRITECH<span class="logo-dot">·</span>
      <span>
        <span class="logo-sub">Mayoristas</span>
      </span>
    </a>
    ...
    <div class="header-actions">
      <?php if ($loggedIn): ?>
        <span class="user-chip mayorista">
          ★ Mayorista
        </span>
        <span style="font-size:.82rem;color:#666"><?= htmlspecialchars($nombre) ?></span>
        <a href="<?php echo APP_URL . 'logout/'; ?>" class="h-link btn-sm">Salir</a>
      <?php else: ?>
        <a href="<?php echo APP_URL . 'login/'; ?>" class="h-link">Ingresar</a>
        <a href="<?php echo APP_URL . 'register/'; ?>" class="h-link" style="border-color:#ddd;color:#333">Registrarse</a>
      <?php endif; ?>
      ...
      <?php if ($loggedIn): ?>
        <a href="<?php echo APP_URL . 'app/mayorista/views/pedidos.php'; ?>" class="h-link">Mis pedidos</a>
      <?php endif; ?>
    </div>
  </div>
  ...
  <nav class="cat-nav">
    <div class="cat-nav-inner" id="catNavInner">
      ...
      <?php
      require_once __DIR__ . '/../../ecommerce/models/ProductoModel.php';
...
<aside class="cart-drawer" id="cartDrawer">
  ...
  <div class="cart-footer" id="cartFooter" style="display:none">
    <div class="mayorista-note">★ Precios mayoristas con descuentos por volumen</div>
    <div class="total-line"><span>Subtotal</span><span id="cartTotal">$0</span></div>
    <div class="total-line"><span>Envío</span><span style="color:#4CAF50">A calcular</span></div>
    <div class="total-line grand"><span>Total estimado</span><span id="cartTotal2" style="font-family:var(--font-mono)">$0</span></div>
    <div class="mt2">
      <a href="<?php echo APP_URL . 'app/mayorista/views/checkout.php'; ?>" class="btn btn-primary btn-full btn-lg">Finalizar compra →</a>
    ...
    <div class="modal-body">
      <div class="modal-grid">
        ...
        <div class="modal-info">
          ...
          <div style="font-size:.8rem;color:#999" id="mBrand"></div>
