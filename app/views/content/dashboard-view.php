	...
	<div class="columns pt-6">
		<div class="column">
			<nav class="level is-mobile">
				<div class="level-item has-text-centered">
					<a href="<?php echo APP_URL; ?>productList/">
						<p class="heading"><i class="fas fa-store fa-fw"></i> &nbsp; Tienda Online</p>
						<p class="title">Acceso Rápido</p>
					</a>
				</div>
				<div class="level-item has-text-centered">
					<a href="<?php echo APP_URL; ?>saleNew/">
						<p class="heading"><i class="fas fa-plus-circle fa-fw"></i> &nbsp; Cargar Venta</p>
						<p class="title">Nueva Venta</p>
					</a>
				</div>
			</nav>
		</div>
